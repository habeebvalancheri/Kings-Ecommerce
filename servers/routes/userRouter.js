...
// Signin
router.get("/signin", middlewares.redirectIfUserLoggedIn,userService.signinPage);  // Render signin page Route
...
router.get('/account-details',middlewares.userLoggedOut,userService.accountDetailsPage);
...
router.get('/order-details',middlewares.userLoggedOut,userService.orderDetails);
